...
val doctorsList = listOf(
    DoctorInfo(
        ...
        bio = "Especialista en arritmias e hipertensión, formación en la Clínica Mayo. Experta en atención personalizada de pacientes con enfermedades cardiovasculares."
    ),
    DoctorInfo(
        id = 2,
        name = "Dr. Luis Vega",
        ...
        bio = "Atención integral de lactantes, niños y adolescentes. Especializado en desarrollo infantil y prevención de enfermedades sistémicas."
    ),
    DoctorInfo(
        id = 3,
        name = "Dra. Rosa Díaz",
        ...
        bio = "Especialista en dermatología clínica y estética, prevención del cáncer de piel y tratamiento avanzado del acné."
    )
)
